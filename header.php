...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = apustheme_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( apustheme_get_config('preload') ) { ?>
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php $header = apply_filters( 'apustheme_get_header_layout', apustheme_get_config('header_type') );
		if ( empty($header) ) {
			$header = 'default';
		}
	?>
