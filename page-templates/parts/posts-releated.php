<?php
    $relate_count = apustheme_get_config('number_blog_releated', 3);
    $relate_columns = apustheme_get_config('releated_blog_columns', 3);
...
?>
    <div class="widget">
        <h4 class="widget-title">
            <span><?php esc_html_e( 'Releated Posts', 'preston' ); ?></span>
        </h4>
