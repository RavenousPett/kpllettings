...
get_header();
$sidebar_configs = apustheme_get_agency_layout_configs();

apustheme_render_breadcrumbs();

?>
<section id="main-container" class="main-content <?php echo apply_filters('apustheme_agency_content_class', 'container');?> inner">
    <div class="row">
