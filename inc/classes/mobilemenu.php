...
if ( !class_exists("Apustheme_Mobile_Menu") ) {
    class Apustheme_Mobile_Menu extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( isset($item->apus_text_label) && !empty($item->apus_text_label) ) {
                switch ( $item->apus_text_label ) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'preston');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'preston');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Featured', 'preston');
                        break;
