...
<div class="property-box property-box-style2" data-latitude="<?php echo esc_attr($latitude); ?>" data-longitude="<?php echo esc_attr($longitude); ?>">
    ...
    <div class="property-box-image <?php if ( ! has_post_thumbnail( $property ) ) { echo 'without-image'; } ?>">
        <a href="<?php the_permalink(); ?>" class="property-box-image-inner <?php if ( ! empty( $agent ) ) : ?>has-agent<?php endif; ?>">
            ...
            <?php if ( has_post_thumbnail( $property ) ) : ?>
            	<?php $thumb_size = isset($image_thumb_size) && $image_thumb_size ? $image_thumb_size : 'property-thumbnail'; ?>
				<?php echo get_the_post_thumbnail( $property, $thumb_size ); ?>
            <?php endif; ?>
            <span class="meta-top">
    			<?php
    	        /**
