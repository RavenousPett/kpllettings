<?php if ( empty( $instance['hide_property_type'] ) ) : ?>
	<div class="form-group">
		...
		<?php if ( 'labels' == $input_titles ) : ?>
			<label for="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_property_type"><?php echo esc_html__( 'Property type', 'preston' ); ?></label>
		<?php endif; ?>
		...
		<select class="form-control" name="filter-property-type" id="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_property_type">
			...
			<option value="">
				<?php if ( 'placeholders' == $input_titles ) : ?>
					<?php echo esc_html__( 'Property type', 'preston' ); ?>
				<?php else : ?>
					<?php echo esc_html__( 'All property types', 'preston' ); ?>
				<?php endif; ?>
			</option>
